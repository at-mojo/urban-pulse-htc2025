      ...
      input: [{
        ...
        content: [
          { 
            ...
            You are a reporting an urban issue on social media. Analyze the image and describe any visible 
            problems related to urban infrastructure, such as potholes, damaged sidewalks, graffiti, or littering. 
            On one to two sentences, describe only the issue in the image; do not suggest solutions or actions to take. 
            Limit your description only to one or two sentences. Assume first-person perspective. 
            Do not narrate, only write the description.`
          },
          { type: 'input_image', image_url: `${s3bucketUrl}/${data.imagePath}`, detail: 'auto'},
        ]
      }]
    })
